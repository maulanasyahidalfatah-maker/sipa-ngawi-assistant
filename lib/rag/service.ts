...
export const TOKEN_TUNING_CONFIG = {
  SUPER_HEMAT: { maxTokens: 1000, maxHistory: 2, temperature: 0.0 },
  HEMAT: { maxTokens: 2500, maxHistory: 4, temperature: 0.0 },
  NORMAL: { maxTokens: 4000, maxHistory: 8, temperature: 0.0 },
};
